        ...
        <div className="self-stretch flex flex-col p-[50px_80px] box-border items-start justify-start gap-[20px] lg:p-[40px] lg:box-border md:p-[30px_24px] md:box-border">
          ...
          <div className="relative w-[1293px] h-[610px] shrink-0 text-lg">
            <img
              ...
              src="../madiun@2x.png"
            />
            <div className="absolute top-[338px] left-[1144px] rounded-[16px] bg-gray-1200 w-[149px] h-[88px] overflow-hidden flex flex-col p-[16px] box-border items-start justify-start gap-[0px]">
            ...
            <div className="absolute top-[484px] left-[1128px] rounded-[16px] bg-gray-1200 w-[149px] h-[88px] overflow-hidden flex flex-col p-[16px] box-border items-start justify-start gap-[0px]">
              <div className="self-stretch rounded-[8px] overflow-hidden flex flex-row p-[16px] box-border items-center justify-center gap-[12px]">
                <div className="relative leading-[24px] font-semibold inline-block">
                  Pacitan
                </div>
            ...
            <div className="absolute top-[71px] left-[105px] rounded-[16px] bg-gray-1200 w-[149px] h-[88px] overflow-hidden flex flex-col p-[16px] box-border items-start justify-start gap-[0px]">
              <div className="self-stretch rounded-[8px] overflow-hidden flex flex-row p-[16px] box-border items-center justify-center gap-[12px]">
                <div className="relative leading-[24px] font-semibold inline-block">
                  Ngawi
                </div>
            ...
            <div className="absolute top-[183px] left-[1101px] rounded-[16px] bg-gray-1200 w-[149px] h-[88px] overflow-hidden flex flex-col p-[16px] box-border items-start justify-start gap-[0px]">
              <div className="self-stretch rounded-[8px] overflow-hidden flex flex-row p-[16px] box-border items-center justify-center gap-[12px]">
                <div className="relative leading-[24px] font-semibold inline-block">
                  Nganjuk
                </div>
            ...
            <div className="absolute top-[37px] left-[1053px] rounded-[16px] bg-gray-1200 w-[149px] h-[88px] overflow-hidden flex flex-col p-[16px] box-border items-start justify-start gap-[0px]">
              <div className="self-stretch rounded-[8px] overflow-hidden flex flex-row p-[16px] box-border items-center justify-center gap-[12px]">
                <div className="relative leading-[24px] font-semibold inline-block">
                  Bojonegoro
                </div>
            ...
            <div className="absolute top-[217px] left-[58px] rounded-[16px] bg-gray-1200 w-[149px] h-[88px] overflow-hidden flex flex-col p-[16px] box-border items-start justify-start gap-[0px]">
              <div className="self-stretch rounded-[8px] overflow-hidden flex flex-row p-[16px] box-border items-center justify-center gap-[12px]">
                <div className="relative leading-[24px] font-semibold inline-block">
                  Magetan
                </div>
            ...
            <div className="absolute top-[363px] left-[0px] rounded-[16px] bg-gray-1200 w-[149px] h-[88px] overflow-hidden flex flex-col p-[16px] box-border items-start justify-start gap-[0px]">
              <div className="self-stretch rounded-[8px] overflow-hidden flex flex-row p-[16px] box-border items-center justify-center gap-[12px]">
                <div className="relative leading-[24px] font-semibold inline-block">
                  Ponorogo
                </div>
